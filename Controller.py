...
def aunthenticate():
  ...
  try :
    ...
    # print(url)
    return redirect('https://console.cloudhiti.com/login',code=302)
...
def passwordchangeauth1():
  ...
  try :
    ...
    return redirect('https://console.cloudhiti.com/resetpassword?uuid='+uuid,code=302)
...
if __name__ == "__main__":
  ...
  app.run(host='0.0.0.0',ssl_context=('/home/ubuntu/consoleApp/ssl/6470adf604c8d281.crt', '/home/ubuntu/consoleApp/ssl/private.key'))
